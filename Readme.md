...
# Parsing + Configuration Script – ENL-AF Flow Synetica - Rev. A

This **Parsing + Configuration** script is designed for the **ENL-AF Flow Synetica** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ENL-AF Flow Synetica Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ENL-AF Flow Synetica** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
